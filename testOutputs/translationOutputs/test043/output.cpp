...
namespace inputs {
	namespace test043 {
		...
		Class __A::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test043.A"), (Class) __rt::null());
			return k;
		};
		...
		Class __B::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test043.B"),__A::__class());
			return k;
		};
		...
		Class __C::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test043.C"),__A::__class());
			return k;
		};
