...
namespace inputs {
	namespace test044 {
		...
		Class __A::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test044.A"), (Class) __rt::null());
			return k;
		};
		...
		Class __B::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test044.B"),__A::__class());
			return k;
		};
		...
		Class __C::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test044.C"),__A::__class());
			return k;
		};
