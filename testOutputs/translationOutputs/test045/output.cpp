...
namespace inputs {
	namespace test045 {
		...
		Class __A::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test045.A"), (Class) __rt::null());
			return k;
		};
		...
		Class __B::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test045.B"),__A::__class());
			return k;
		};
		...
		Class __C::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test045.C"),__A::__class());
			return k;
		};
