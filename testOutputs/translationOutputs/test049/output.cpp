...
namespace inputs {
	namespace test049 {
		...
		Class __A::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test049.A"), (Class) __rt::null());
			return k;
		};
		...
		Class __B::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test049.B"),__A::__class());
			return k;
		};
		...
		Class __C::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test049.C"),__A::__class());
			return k;
		};
