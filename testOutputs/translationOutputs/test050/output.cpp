...
namespace inputs {
	namespace test050 {
		...
		Class __A::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test050.A"), (Class) __rt::null());
			return k;
		};
		...
		Class __B::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test050.B"),__A::__class());
			return k;
		};
		...
		Class __C::__class() {
			static Class k =
			new __Class(__rt::literal("inputs.test050.C"),__A::__class());
			return k;
		};
